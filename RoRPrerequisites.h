...
#define TOSTRING(x)  std::stringConverter::toString(x)
#define TOUTFSTRING(x)  ANSI_TO_UTF(std::stringConverter::toString(x))
#define PARSEINT(x)  std::stringConverter::parseInt(x)
#define PARSEREAL(x) std::stringConverter::parseReal(x)
