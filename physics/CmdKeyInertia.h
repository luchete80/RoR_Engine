...
public:
    ...
    //Ogre::SimpleSpline* GetSplineByName(std::string model);	//LUCIANO;: TODO UNCOMENT

private:
    //std::map<std::string, Ogre::SimpleSpline> m_splines;		//LUCIANO;: TODO UNCOMENT
};
