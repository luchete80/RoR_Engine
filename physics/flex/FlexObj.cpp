    ...
    m_gfx_actor(gfx_actor)
{
    ...
    {
        irr::core::vector3df base_pos = all_nodes[m_vertex_nodes[m_indices[i*3]]].RelPosition;
        irr::core::vector3df v1       = all_nodes[m_vertex_nodes[m_indices[i*3+1]]].RelPosition - base_pos;
        irr::core::vector3df v2       = all_nodes[m_vertex_nodes[m_indices[i*3+2]]].RelPosition - base_pos;
...
Vector3 FlexObj::UpdateMesh()
{
    ...
    irr::core::vector3df center=(all_nodes[m_vertex_nodes[0]].AbsPosition+all_nodes[m_vertex_nodes[1]].AbsPosition)/2.0;
    for (size_t i=0; i<m_vertex_count; i++)
    {
        //set position
...
{
    irr::core::vector3df center = this->UpdateMesh();
    m_hw_vbuf->writeData(0, m_hw_vbuf->getSizeInBytes(), m_vertices_raw, true);
    return center;
}
